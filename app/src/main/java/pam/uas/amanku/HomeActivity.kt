...
class HomeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.submitButton.setOnClickListener {
            ...
            val lokasi = binding.lokasiTextView.text.toString()
        ...
        binding.buttonLihatLaporan.setOnClickListener {
            val intent = Intent(this, DaftarLaporanActivity::class.java)
            startActivity(intent)
        }

        binding.logoutButton.setOnClickListener { // Asumsikan ada tombol dengan id logoutButton
            logout()
        }
    }
    ...
    private fun simpanDataKeFirebase(laporan: Laporan) {
        ...
        database.child("laporan").child(laporanId).setValue(updatedLaporan)
            .addOnSuccessListener {
                ...
                // 4. (Opsional) Kembali ke halaman sebelumnya (jika ada)
                //    finish() // Jika HomeActivity adalah satu-satunya activity di back stack, ini akan menutup aplikasi.

                // 5. (Opsional) Navigasi ke halaman lain, misalnya halaman list laporan
                //    val intent = Intent(this, DaftarLaporanActivity::class.java)
                //    startActivity(intent)
            }
